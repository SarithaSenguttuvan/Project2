...
{
    int8_t reg_addr = I2C_ACC_CONTROL_REG2 | I2C_CMD_CODE_ACC;       /* Reg address with command code */
    write_reg_acc(reg_addr, value);                                 /* Write to the register */
    return 0;
}
...
{
    int8_t reg_addr = I2C_FF_MT_CFG | I2C_CMD_CODE_ACC;       /* Reg address with command code */
    write_reg_acc(reg_addr, value);                                 /* Write to the register */
    return 0;
}
...
{
    int8_t reg_addr = I2C_FF_MT_THS | I2C_CMD_CODE_ACC;       /* Reg address with command code */
    write_reg_acc(reg_addr, value);                                 /* Write to the register */
    return 0;
}
...
{
    int8_t reg_addr = I2C_FF_MT_COUNT | I2C_CMD_CODE_ACC;       /* Reg address with command code */
    write_reg_acc(reg_addr, value);                                 /* Write to the register */
    return 0;
}
...
{
    int8_t reg_addr = I2C_ACC_CONTROL_REG4 | I2C_CMD_CODE_ACC;       /* Reg address with command code */
    write_reg_acc(reg_addr, value);                                 /* Write to the register */
    return 0;
}
